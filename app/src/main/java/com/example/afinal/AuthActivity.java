...
public class AuthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewInicio = findViewById(R.id.txtBack); // Obtener el TextView
        // Asignar un OnClickListener al TextView
        textViewInicio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               /* Intent intent = new Intent(AuthActivity.this, StartActivity.class);
