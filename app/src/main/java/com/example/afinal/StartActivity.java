...
public class StartActivity extends AppCompatActivity {
    ...
    private String id;
    private TextView textViewInfo;// Cambiar a TextView
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewInfo = findViewById(R.id.textViewInfo); // Reemplaza R.id.textViewInfo con el ID correcto de tu TextView

        textViewInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LayoutInflater inflater = getLayoutInflater();
                View dialogView = inflater.inflate(R.layout.integrante_info, null);
                ...
                positiveButton.setTextColor(ContextCompat.getColor(StartActivity.this, R.color.teal_700));
